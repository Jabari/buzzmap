...
app.controller('UploadCtrl', ['$scope', '$cordovaGeolocation', '$timeout', '$sce', '$ionicHistory', 'PinFactory', 'map_style', '$ionicPopup', function($scope, $cordovaGeolocation, $timeout, $sce, $ionicHistory, PinFactory, map_style, $ionicPopup){
  $scope.$on('mapInitialized', function(event, map) {
    ...
    //$(window)
    /**
    angular.element(document.querySelector('window'))
    .bind('load', function() {
        handleClientLoad();
    });
    **/
    ...
    ref.on('value', function(snapshot, event) {
        ...
        angular.element(document.querySelector('#upload')).bind('submit', function() {
            ...
            var vidTitle = document.getElementById('title').value;
    ...
    **/
    ...
    if ($scope.title.$dirty === true) console.log('dirty');//angular.element(document.querySelector('#id').css("color", "#fff"));
